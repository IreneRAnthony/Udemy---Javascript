...
const controlRecipe = async () => {
    ...
    if (id) {
        ...
        renderTheLoader(elements.recipe);
...
// Handle delete and item list update events
...
window.addEventListener('load', () => {
    ...
    state.likes.likes.forEach(like => likesView.renderTheLike(like));
});
